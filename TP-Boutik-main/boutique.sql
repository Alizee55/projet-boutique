...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 15 oct. 2021 à 12:27
...
CREATE TABLE IF NOT EXISTS `photo` (
  ...
  PRIMARY KEY (`idphoto`),
  KEY `produit_photo_FK` (`id_produit`)
...
INSERT INTO `produit` (`codeProduit`, `designationProduit`, `prixProduit`, `stockProduit`, `photoProduit`, `idCategorie`, `type`) VALUES
